          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            >
              <img
                ...
                class="w-10 h-10 mb-4"
              />
              <h3 class="text-xl font-semibold mb-2">Horaires</h3>
...
<div class="py-5 px-4">
  ...
  <p class="louis text-lg mb-6 text-center">
    N’hésitez pas à me suivre sur les réseaux sociaux pour découvrir les dernières créations et les actus de la boutique.
  </p>
